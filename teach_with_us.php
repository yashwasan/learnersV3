                  ...
                  <form class="" method="post">
                     ...
                     <div class="">
                        <select class="pl-5 mont form-select form-control book_a_cls_inpt" required>
                           ...
                           <option value="Mathematics" class="jost">Mathematics : Class 5th - 8th</option>
                           <option value="Mathematics" class="jost">Science : Class 5th - 8th</option>
                           <option value="Mathematics" class="jost">Social Science : Class 5th - 8th</option>
                           <option value="Mathematics" class="jost">Mathematics : Class 9th - 10th</option>
                           <option value="Mathematics" class="jost">Science : Class 9th - 10th</option>
                           <option value="Mathematics" class="jost">Social Science : Class 9th - 10th</option>
                           <option value="Mathematics" class="jost">Mathematics : Class 11th - Class 12th</option>
                           <option value="Mathematics" class="jost">Physics : Class 11th - Class 12th</option>
                           <option value="Mathematics" class="jost">Chemistry : Class 11th - Class 12th</option>
                           <option value="Mathematics" class="jost">Biology : Class 11th - Class 12th</option>
                           <option value="Mathematics" class="jost">Accountancy : Class 11th - Class 12th</option>
                           <option value="Mathematics" class="jost">Business Studies : Class 11th - Class 12th</option>
                           <option value="Mathematics" class="jost">Economics : Class 11th - Class 12th</option>
                           <option value="Mathematics" class="jost">History : Class 11th - Class 12th</option>
                           <option value="Mathematics" class="jost">Political Science : Class 11th - Class 12th</option>
                           <option value="Mathematics" class="jost">Geography : Class 11th - Class 12th</option>
                           <option value="Mathematics" class="jost">Psychology : Class 11th - Class 12th</option>
                           <option value="Mathematics" class="jost">Others</option>
                        </select>
                     </div>
                     <br>
                     <div class="d-flex">
