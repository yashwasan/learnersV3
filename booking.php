            ...
            <div class="col-lg-8">
               <div class="book_a_free_class_div px-4 py-3">
                  ...
                  <form method="post">
                     ...
                     <div class="row">
                        <div class="col-lg-4 mb-3">
                           <input type="text" name="" value="" class="form-control book_a_cls_inpt" required placeholder="Your City *">
                        </div>
                        <div class="col-lg-4 mb-3">
                        ...
                        <div class="col-lg-4 mb-3">
                           <select class="form-select book_a_cls_inpt jost" name="" required>
                              ...
                              <option value="">9 AM - 12 PM</option>
                              <option value="">12 PM - 3 PM</option>
                              <option value="">3 PM - 6 PM</option>
                              <option value="">6 PM - 9 PM</option>
                           </select>
                        </div>
                     </div>
                     ...
                     <div class="text-center" role="group" aria-label="Basic radio toggle button group">
                        ...
                        <label class="btn btn-outline-warning bd-radius" for="btnradio12">11 - S</label>
                        <input type="radio" class="btn-check" name="btnradio" id="btnradio13" autocomplete="off">
                        <label class="btn btn-outline-warning bd-radius" for="btnradio13">11 - C</label>
                        <input type="radio" class="btn-check" name="btnradio" id="btnradio14" autocomplete="off">
                        <label class="btn btn-outline-warning bd-radius" for="btnradio14">11 - H</label>
                        <input type="radio" class="btn-check" name="btnradio" id="btnradio15" autocomplete="off">
                        <label class="btn btn-outline-warning bd-radius" for="btnradio15">12 - S</label>
                        <!-- <div class="mt-2"></div> -->
                        <input type="radio" class="btn-check" name="btnradio" id="btnradio16" autocomplete="off">
                        <label class="btn btn-outline-warning bd-radius" for="btnradio16">12 - C</label>
                        <input type="radio" class="btn-check" name="btnradio" id="btnradio17" autocomplete="off">
                        <label class="btn btn-outline-warning bd-radius" for="btnradio17">12 - H</label>
